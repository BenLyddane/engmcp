...
import { loadMasterSpecTypes, clearMasterFile, ensureOutputDir, getMasterFilePath, } from './utils/fileManager.js';
/**
...
async function runTestMode() {
    ...
    const output = {
        ...
        metadata: {
            ...
            domains: {
                ...
                FIRE_PROTECTION: allSpecTypes.filter((s) => s.domain === 'FIRE_PROTECTION').length,
            },
        },
    };
    ...
    console.log('If satisfied, run "npm run generate:full" for full generation.');
    console.log('To start fresh, run with --clear flag: "npm run generate:test -- --clear"\n');
}
/**
