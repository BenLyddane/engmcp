 ...
 */
export function loadMasterSpecTypes(): SpecType[] {
  ensureOutputDir();
 ...
 */
export function saveSpecTypeToMaster(specType: SpecType): void {
  ensureOutputDir();
 ...
 */
export function clearMasterFile(): void {
  ensureOutputDir();
 ...
 */
export function getMasterFilePath(): string {
  return MASTER_FILE;
}
